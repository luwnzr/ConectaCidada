...
// lat/lng coords for Brasília / Taguatinga / DF area
const SERVICES = [
  // ── SAÚDE ──────────────────────────────────────────────────────────────────
  { id:1,  category:"saude",       name:"Hospital Regional de Taguatinga — HRT",   address:"AE 5, Setor E — Taguatinga, Brasília-DF",               phone:"(61) 3451-5600", hours:"24 horas",            status:"aberto", rating:4.0, gratuito:true,  lat:-15.8290, lng:-48.0580, services:["Pronto-socorro","Internação","Cirurgia","Maternidade","Emergência 24h"],       description:"Principal hospital público de Taguatinga, referência regional para urgência e emergência." },
  { id:2,  category:"saude",       name:"UBS 1 Taguatinga Norte",                  address:"QNE 40, Área Especial — Taguatinga Norte, Brasília-DF", phone:"(61) 3451-5700", hours:"Seg–Sex: 07h às 19h", status:"aberto", rating:4.1, gratuito:true,  lat:-15.8140, lng:-48.0500, services:["Clínica geral","Vacinação","Pré-natal","Pediatria","Exames básicos"],          description:"Unidade Básica de Saúde atendendo a população de Taguatinga Norte pelo SUS." },
  { id:3,  category:"saude",       name:"UBS 3 Taguatinga Centro",                 address:"QSA 17, Área Especial — Taguatinga Centro, Brasília-DF",phone:"(61) 3451-5720", hours:"Seg–Sex: 07h às 19h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.8340, lng:-48.0460, services:["Clínica geral","Vacinação","Saúde da mulher","Coleta de exames"],               description:"UBS com atendimento completo para moradores de Taguatinga Centro." },
  { id:4,  category:"saude",       name:"Centro de Saúde 2 de Taguatinga",         address:"QSD 5, Área Especial — Taguatinga, Brasília-DF",        phone:"(61) 3451-5740", hours:"Seg–Sex: 07h às 18h", status:"aberto", rating:3.9, gratuito:true,  lat:-15.8390, lng:-48.0430, services:["Atenção primária","Saúde mental","Fisioterapia","Vacinação"],                 description:"Centro de Saúde de referência para Taguatinga Sul e arredores." },
  { id:5,  category:"saude",       name:"UBS 4 Taguatinga Sul",                    address:"QSE 12, Área Especial — Taguatinga Sul, Brasília-DF",   phone:"(61) 3451-5760", hours:"Seg–Sex: 07h às 19h", status:"aberto", rating:4.2, gratuito:true,  lat:-15.8460, lng:-48.0510, services:["Clínica geral","Vacinação","Saúde do idoso","Pré-natal"],                     description:"Unidade Básica de Saúde atendendo Taguatinga Sul com serviços de atenção primária." },

  // ── ASSISTÊNCIA SOCIAL ─────────────────────────────────────────────────────
  { id:6,  category:"assistencia", name:"CRAS — Asa Sul",                          address:"Asa Sul, Brasília-DF",                                  phone:"(61) 3773-7356", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:4.1, gratuito:true,  lat:-15.8350, lng:-47.9250, services:["CadÚnico","Bolsa Família e benefícios","Apoio familiar e social"],             description:"CRAS da Asa Sul. Outros núcleos: Paranoá (61) 3369-7903 · Varjão (61) 3468-1862 · Candangolândia (61) 3301-7735." },
  { id:7,  category:"assistencia", name:"CREAS — Asa Sul",                         address:"Asa Sul, Brasília-DF",                                  phone:"(61) 3773-7489", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.8380, lng:-47.9230, services:["Atendimento a vítimas de violência","Violação de direitos","Apoio psicológico especializado"], description:"Centro de Referência Especializado — atendimento em situações de risco pessoal e social." },
  { id:8,  category:"assistencia", name:"CREAS — Ceilândia",                       address:"Ceilândia, Brasília-DF",                                phone:"(61) 3581-6005", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.8100, lng:-48.1050, services:["Proteção social","Atendimento a famílias em risco","Orientação jurídica"],       description:"Atendimento especializado a famílias em situação de vulnerabilidade em Ceilândia." },
  { id:9,  category:"assistencia", name:"CREAS — Taguatinga",                      address:"Taguatinga Sul, Brasília-DF",                           phone:"(61) 3773-7519", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:4.1, gratuito:true,  lat:-15.8420, lng:-48.0490, services:["Atendimento especializado","Situações de vulnerabilidade","Apoio psicossocial"],  description:"CREAS de Taguatinga com atendimento especializado para famílias em situação de risco." },
  { id:10, category:"assistencia", name:"CREAS — São Sebastião",                   address:"São Sebastião, Brasília-DF",                            phone:"(61) 3773-7650", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:3.9, gratuito:true,  lat:-15.9050, lng:-47.8020, services:["Apoio social e psicológico","Atendimento em casos de violência"],                description:"Atendimento de famílias em situação de violência e vulnerabilidade social." },
  { id:11, category:"assistencia", name:"Centro POP — População de Rua",           address:"Asa Sul, Brasília-DF",                                  phone:"(61) 3773-7562", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:4.2, gratuito:true,  lat:-15.8360, lng:-47.9270, services:["Atendimento à população de rua","Alimentação e higiene","Encaminhamento social"],description:"Centro de Referência Especializado para População em Situação de Rua." },
  { id:12, category:"assistencia", name:"Pop Taguatinga Center",                   address:"Taguatinga, Brasília-DF",                               phone:"(61) 3563-1046", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.8310, lng:-48.0560, services:["Apoio social","Atendimento à população vulnerável","Encaminhamentos"],          description:"Atendimento social a pessoas em situação de vulnerabilidade na região de Taguatinga." },
  { id:13, category:"assistencia", name:"Restaurante Comunitário — Estrutural",    address:"Estrutural, Brasília-DF",                               phone:"156 (GDF)",      hours:"Seg–Sex: 07h às 14h", status:"aberto", rating:4.3, gratuito:true,  lat:-15.7820, lng:-47.9880, services:["Refeições gratuitas ou de baixo custo","Segurança alimentar"],                  description:"Restaurante comunitário do GDF com refeições subsidiadas para população de baixa renda." },
  { id:14, category:"assistencia", name:"Restaurante Comunitário — Varjão",        address:"Varjão, Brasília-DF",                                   phone:"156 (GDF)",      hours:"Seg–Sex: 07h às 14h", status:"aberto", rating:4.1, gratuito:true,  lat:-15.7360, lng:-47.8900, services:["Alimentação acessível","Apoio social"],                                          description:"Restaurante comunitário com refeições de baixo custo para moradores do Varjão." },
  { id:15, category:"assistencia", name:"Restaurante Comunitário — Samambaia",     address:"Samambaia, Brasília-DF",                                phone:"156 (GDF)",      hours:"Seg–Sex: 07h às 20h", status:"aberto", rating:4.2, gratuito:true,  lat:-15.8820, lng:-48.0780, services:["Café da manhã","Almoço e jantar social","Apoio alimentar"],                      description:"Restaurante Rorizão — café, almoço e jantar com preços acessíveis para toda a comunidade." },
  { id:16, category:"assistencia", name:"Restaurante Comunitário — Brazlândia",    address:"Brazlândia, Brasília-DF",                               phone:"(61) 3479-2796", hours:"Seg–Sex: 07h às 14h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.6750, lng:-48.1950, services:["Alimentação de baixo custo","Apoio à população vulnerável"],                    description:"Restaurante comunitário servindo refeições acessíveis à população de Brazlândia." },

  // ── EDUCAÇÃO ────────────────────────────────────────────────────────────────
  { id:17, category:"educacao",    name:"IFB — Campus Brasília",                   address:"SGAN 610 — Asa Norte, Brasília-DF",                     phone:"(61) 2103-2154", hours:"Seg–Sex: 07h às 22h", status:"aberto", rating:4.5, gratuito:true,  lat:-15.7565, lng:-47.8895, services:["Cursos técnicos gratuitos","Cursos rápidos FIC","Tecnologia","Administração","Eventos"],  description:"Instituto Federal de Brasília — formação técnica e profissional gratuita de alto nível." },
  { id:18, category:"educacao",    name:"IFB — Campus São Sebastião",              address:"Área Especial 2 — São Sebastião, Brasília-DF",           phone:"(61) 2193-8130", hours:"Seg–Sex: 07h às 22h", status:"aberto", rating:4.4, gratuito:true,  lat:-15.9030, lng:-47.8070, services:["Cursos profissionalizantes gratuitos","Capacitação para jovens e adultos"],         description:"Campus IFB focado em qualificação profissional para a comunidade de São Sebastião." },
  { id:19, category:"educacao",    name:"IFB — Campus Gama",                       address:"Rodovia DF 480 — Gama, Brasília-DF",                     phone:"(61) 2103-2250", hours:"Seg–Sex: 07h às 22h", status:"aberto", rating:4.4, gratuito:true,  lat:-16.0110, lng:-48.0570, services:["Cursos técnicos","Formação industrial","Tecnologia"],                              description:"Campus IFB no Gama com foco em formação técnica industrial e tecnológica." },
  { id:20, category:"educacao",    name:"SENAC — Asa Sul",                         address:"SEUPS 703/903 Sul — Brasília-DF",                        phone:"(61) 3771-9832", hours:"Seg–Sáb: 07h às 22h", status:"aberto", rating:4.4, gratuito:false, lat:-15.8065, lng:-47.8975, services:["Cursos gratuitos PSG","Gastronomia","TI","Administração","Saúde e beleza"],          description:"SENAC Asa Sul com cursos técnicos e gratuitos pelo Programa Senac Gratuidade (PSG)." },
  { id:21, category:"educacao",    name:"SENAC — Taguatinga",                      address:"Área Especial 39 — Taguatinga, Brasília-DF",             phone:"(61) 3771-9883", hours:"Seg–Sáb: 07h às 22h", status:"aberto", rating:4.3, gratuito:false, lat:-15.8350, lng:-48.0530, services:["Cursos técnicos","Informática","RH","Contabilidade","Estética"],                   description:"SENAC Taguatinga com ampla oferta de cursos técnicos e profissionalizantes." },
  { id:22, category:"educacao",    name:"SENAC — Ceilândia",                       address:"QNN 1 — Ceilândia, Brasília-DF",                         phone:"(61) 3771-9829", hours:"Seg–Sáb: 07h às 22h", status:"aberto", rating:4.2, gratuito:false, lat:-15.8070, lng:-48.1040, services:["Cursos gratuitos","TI","Moda","Beleza","Administração"],                              description:"SENAC Ceilândia com cursos gratuitos e profissionalizantes para a comunidade local." },
  { id:23, category:"educacao",    name:"SENAC — Gama",                            address:"Ponte Alta Norte — Gama, Brasília-DF",                   phone:"(61) 3771-9813", hours:"Seg–Sáb: 07h às 22h", status:"aberto", rating:4.2, gratuito:false, lat:-16.0090, lng:-48.0620, services:["Cursos profissionalizantes","Capacitação para o mercado de trabalho"],               description:"SENAC Gama com cursos voltados à empregabilidade e desenvolvimento profissional." },
  { id:24, category:"educacao",    name:"SENAI DF — Taguatinga / Gama / Sobradinho",address:"Unidades em Taguatinga, Gama, Sobradinho e SIG — DF",  phone:"(61) 3213-0700", hours:"Seg–Sex: 07h às 22h", status:"aberto", rating:4.5, gratuito:true,  lat:-15.8370, lng:-48.0540, services:["Cursos técnicos gratuitos","Mecânica","Elétrica","Construção","Tecnologia"],      description:"SENAI DF com cursos técnicos gratuitos nas áreas industrial e tecnológica em várias unidades." },
  { id:25, category:"educacao",    name:"QualificaDF — Governo do DF",             address:"Várias regiões do DF (unidades móveis e polos)",         phone:"(61) 3315-9000", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:4.3, gratuito:true,  lat:-15.7790, lng:-47.9350, services:["Cursos rápidos gratuitos","Cuidador de idosos","Informática","Gastronomia","Beleza","Administração"], description:"Programa de qualificação profissional gratuito do GDF com unidades móveis em todo o DF." },

  // ── ODONTOLOGIA ─────────────────────────────────────────────────────────────
  { id:26, category:"odontologia", name:"CEO Taguatinga",                          address:"Área Especial 34, Setor C Norte — Taguatinga, DF",      phone:"(61) 3351-2150", hours:"Seg–Sex: 07h às 19h", status:"aberto", rating:4.3, gratuito:true,  lat:-15.8215, lng:-48.0498, services:["Restauração","Periodontia","Cirurgia oral","Endodontia","Prótese dentária"],      description:"Centro de Especialidades Odontológicas de referência para Taguatinga — atendimento 100% pelo SUS." },
  { id:27, category:"odontologia", name:"Odontologia — UBS 1 Taguatinga Norte",    address:"QNE 40, Área Especial — Taguatinga Norte, Brasília-DF", phone:"(61) 3451-5700", hours:"Seg–Sex: 07h às 18h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.8145, lng:-48.0505, services:["Prevenção bucal","Restauração básica","Extração","Orientação de higiene"],        description:"Serviço odontológico integrado à UBS 1 de Taguatinga Norte — atendimento SUS." },
  { id:28, category:"odontologia", name:"Odontologia — UBS 3 Taguatinga Centro",   address:"QSA 17, Área Especial — Taguatinga Centro, Brasília-DF",phone:"(61) 3451-5720", hours:"Seg–Sex: 07h às 18h", status:"aberto", rating:3.9, gratuito:true,  lat:-15.8345, lng:-48.0465, services:["Prevenção bucal","Restauração","Extração","Fluoretação"],                          description:"Consultório odontológico integrado à UBS 3 de Taguatinga Centro." },
  { id:29, category:"odontologia", name:"Centro de Saúde 2 — Setor Odontológico",  address:"QSD 5, Área Especial — Taguatinga, Brasília-DF",        phone:"(61) 3451-5740", hours:"Seg–Sex: 07h às 18h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.8395, lng:-48.0435, services:["Odontologia preventiva","Restauração","Prótese dentária básica"],               description:"Setor odontológico do Centro de Saúde 2 de Taguatinga." },
  { id:30, category:"odontologia", name:"Odontologia — UBS 4 Taguatinga Sul",      address:"QSE 12, Área Especial — Taguatinga Sul, Brasília-DF",   phone:"(61) 3451-5760", hours:"Seg–Sex: 07h às 18h", status:"aberto", rating:4.1, gratuito:true,  lat:-15.8465, lng:-48.0515, services:["Prevenção","Restauração","Extração","Saúde bucal infantil"],                     description:"Atendimento odontológico SUS integrado à UBS 4 de Taguatinga Sul." },
  { id:31, category:"odontologia", name:"Odontologia — UBS Taguatinga Sul (QSC)",  address:"QSC 12, Área Especial — Taguatinga Sul, Brasília-DF",   phone:"(61) 3451-5780", hours:"Seg–Sex: 07h às 18h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.8490, lng:-48.0480, services:["Prevenção bucal","Restauração","Extração","Orientação de higiene"],            description:"Unidade odontológica da QSC de Taguatinga Sul com atendimento gratuito pelo SUS." },

  // ── PSICOLOGIA ──────────────────────────────────────────────────────────────
  { id:32, category:"psicologia",  name:"CAPS II — Taguatinga",                    address:"QSC 1, Área Especial — Taguatinga Sul, Brasília-DF",    phone:"(61) 3451-5900", hours:"Seg–Sex: 08h às 18h", status:"aberto", rating:4.5, gratuito:true,  lat:-15.8420, lng:-48.0460, services:["Psicoterapia individual","Grupos terapêuticos","Atendimento psiquiátrico","Reabilitação psicossocial"], description:"Centro de Atenção Psicossocial II de Taguatinga com equipe multidisciplinar em saúde mental." },
  { id:33, category:"psicologia",  name:"UCB — Psicologia Gratuita",               address:"QS 7, Lote 1 — Taguatinga, Brasília-DF",               phone:"(61) 3356-9000", hours:"Seg–Sex: 08h às 20h", status:"aberto", rating:4.7, gratuito:true,  lat:-15.8284, lng:-48.0421, services:["Terapia individual","Terapia de casal","Atendimento infantil","Orientação vocacional"],description:"Clínica-escola da UCB com psicoterapia gratuita por alunos supervisionados por professores." },
  { id:34, category:"psicologia",  name:"CAPS AD — Ceilândia",                     address:"QNM 10, Módulo B — Ceilândia, Brasília-DF",             phone:"(61) 3372-5460", hours:"Seg–Sex: 08h às 18h", status:"aberto", rating:4.3, gratuito:true,  lat:-15.8050, lng:-48.1070, services:["Tratamento de dependência química","Psicoterapia","Grupos de apoio","Atendimento familiar"],description:"CAPS AD de Ceilândia especializado em álcool e outras drogas, com atendimento multidisciplinar." },
  { id:35, category:"psicologia",  name:"CAPS II — Ceilândia",                     address:"QNM 28, Conjunto A — Ceilândia, Brasília-DF",           phone:"(61) 3371-3460", hours:"Seg–Sex: 08h às 18h", status:"aberto", rating:4.3, gratuito:true,  lat:-15.8120, lng:-48.1090, services:["Saúde mental","Psicoterapia em grupo","Atendimento psiquiátrico","Oficinas terapêuticas"],description:"CAPS II de Ceilândia — referência em saúde mental para toda a região." },
  { id:36, category:"psicologia",  name:"Núcleo de Psicologia — UniCEUB",          address:"SEPN 707/907 — Asa Norte, Brasília-DF",                 phone:"(61) 3966-1201", hours:"Seg–Sex: 08h às 18h", status:"aberto", rating:4.4, gratuito:true,  lat:-15.7592, lng:-47.8840, services:["Psicoterapia individual","Avaliação psicológica","Orientação familiar"],           description:"Clínica-escola do UniCEUB com atendimento psicológico gratuito supervisionado." },
  { id:37, category:"psicologia",  name:"CAPSi Infanto-Juvenil — Taguatinga",      address:"QSB 2, Área Especial — Taguatinga, Brasília-DF",        phone:"(61) 3451-5910", hours:"Seg–Sex: 08h às 17h", status:"aberto", rating:4.4, gratuito:true,  lat:-15.8360, lng:-48.0530, services:["Saúde mental infantojuvenil","Autismo","Psicoterapia","Apoio escolar"],            description:"CAPS Infanto-Juvenil para crianças e adolescentes com transtornos mentais em Taguatinga." },

  // ── JURÍDICO ────────────────────────────────────────────────────────────────
  { id:38, category:"juridico",    name:"Defensoria Pública do DF",                address:"Vários núcleos pelo DF — consulte o site ou ligue 129", phone:"129 (gratuito)", hours:"Seg–Sex: 08h às 18h", status:"aberto", rating:4.2, gratuito:true,  lat:-15.7628, lng:-47.8920, services:["Família","Trabalhista","Consumidor","Criminal","Habitação","Previdência"],         description:"Assistência jurídica gratuita para pessoas de baixa renda em todas as áreas. WhatsApp: (61) 98100-7200." },
  { id:39, category:"juridico",    name:"Defensoria Pública da União",              address:"SBS Quadra 01 — Brasília-DF",                           phone:"(61) 3105-7355", hours:"Seg–Sex: 08h às 18h", status:"aberto", rating:4.1, gratuito:true,  lat:-15.7990, lng:-47.8740, services:["Ações contra INSS","Caixa Econômica","Órgãos federais","Previdência social"],   description:"Atendimento jurídico gratuito para causas contra órgãos federais — INSS, Caixa, Receita Federal." },
  { id:40, category:"juridico",    name:"Núcleo de Prática Jurídica — UniCEUB",    address:"Asa Sul — Fórum Júlio Fabrini Mirabete, Brasília-DF",   phone:"(61) 3966-1201", hours:"Seg–Sex: 09h às 17h", status:"aberto", rating:3.9, gratuito:true,  lat:-15.8090, lng:-47.9020, services:["Família","Consumidor","Orientação jurídica","Mediação"],                         description:"Atendimento jurídico gratuito por alunos do UniCEUB supervisionados por advogados, para causas simples." },
  { id:41, category:"juridico",    name:"SINTIBREF-DF — Orientação Jurídica",      address:"Setor de Diversões Sul, CONIC — Brasília-DF",           phone:"(61) 3226-0300", hours:"Seg–Sex: 09h às 17h", status:"aberto", rating:4.0, gratuito:true,  lat:-15.8000, lng:-47.8820, services:["Trabalhista","Previdenciário","Família","Consumidor"],                              description:"Orientação jurídica gratuita nas áreas trabalhista, previdenciária, família e consumo." },
];
